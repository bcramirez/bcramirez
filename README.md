...
|---|---|---|
| [bank customer churn analysis](https://github.com/bcramirez/bank-customer-churn-analysis) | ML project predicting which customers are most likely to close their bank accounts | python, linear regression, random forest, Tableau |
